...
public class MultipleImageSelectionActivity extends MultipleImageSelectionBaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.multipleimage_gridview);
...
*/
	...
	public void btnChoosePhotosClick(View v) {
		...
		Toast.makeText(MultipleImageSelectionActivity.this,
				"Total photos selected: " + selectedItems.size(),
				Toast.LENGTH_SHORT).show();
		Log.d(MultipleImageSelectionActivity.class.getSimpleName(),
				"Selected Items: " + selectedItems.toString());
		
		Intent intent = this.getIntent();
		intent.putStringArrayListExtra(GlobalData.CONTENT_IMAGE_MULTIPLE_SELECTIONS,selectedItems);
		this.setResult(GlobalData.CONTENT_IMAGE_ACTIVITY_REQUEST_CODE, intent);
		this.finish();
	...
	public class ImageAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
				convertView = mInflater.inflate(R.layout.multipleimage_gridview_item,
						null);
			}
